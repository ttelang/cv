...
// Usage example:
async function generateResume(jsonPath = '../tarun/resume-jpmc-director.json', containerId = 'resume-container') {
    try {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (resumeContainer) {
        const jsonPath = resumeContainer.dataset.jsonPath || './tarun/resume-jpmc-director.json';
